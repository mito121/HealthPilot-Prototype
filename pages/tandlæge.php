<div ng-controller="mainCtrl" ng-init="show_results(); show_highscore_institutions()" style="background-color:#fff">
		...
		<div class="row mx-1 pt-5 result-box">
			...
			<div class="col">
				<div class="search-delete-box">
					<input type="text" class="form-control" id="searchText" placeholder="Søg på behandler" ng-model="search" ng-click="toogle()" ng-change="changeSearchBlock()">
          
          <div class="delete-search" style="{{displaySearch}}">
            <a href="" title="Slet søgning" class="search-delete" ng-click="clear_search()"><img src="../images/icons-png/delete-black.png" width="14" height="14" alt=""/></a>
          </div>
				</div>
			</div>
			...
			<div class="col">
				<div class="search-delete-box">
					<input type="text" class="form-control" id="searchCity" placeholder="Søg på postnummer" ng-model="searchCity" ng-change="changeCityBlock()">
          
          <div class="delete-city" style="{{displayCity}}">
            <a href="" title="Slet by" class="search-delete" ng-click="clear_city_search()"><img src="../images/icons-png/delete-black.png" width="14" height="14" alt=""/></a>
          </div>
        </div>
			</div>
	...
	<div class="container-fluid py-2 mb-5" style="background-color:#f7f7f3">
		<div class="container mb-5">
			<div class="col-12">
				<div class="my-5">
					<h2>De 10 mest populære tandlæger i de seneste tre måneder</h2>
				</div>
			</div>
