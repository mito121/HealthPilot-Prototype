<div ng-controller="mainCtrl" ng-init="show_results(); show_highscore_institutions()" style="background-color:#F3F6E0">
	<div class="container pt-5">
        ...
        <h1>Diætister</h1>
          ...
          <img class='img-practice' src="../uploads/diet-150x150.png">
      </div>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-12 pt-3">
						<table class="table-striped tbl_result">
							...
							<tr class="tr_result" dir-paginate="x in results | filter: {i_name : search} | filter: {zip_id : searchCity} | filter: {practice_id : '21'}:true | orderBy:sortKey:reverse | itemsPerPage : searchNumber">
	...
	<div class="container-fluid py-2 mb-5" style="background-color:#f7f7f3">
		<div class="container mb-5">
			...
			<div class="row col-12 justify-content-around">
				<div class="d-flex flex-row" ng-repeat="x in highscoreInst | filter: {p_id : '21'}:true | limitTo:10">
